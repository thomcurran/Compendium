---
title: "Example Confirmatory Data Analysis Plan"
...
```{r}
data <- read_csv("C:/Users/CURRANT/Documents/Compendium/Data/data.csv")
```
...
ggsave(file="C:/Users/CURRANT/Documents/Compendium/Plots/plot_1.png")
```
...
```{r}
library(apaTables)
apa.1way.table(iv=condition,dv=heads,data=data,filename="C:/Users/CURRANT/Documents/Compendium/Tables/table_1.doc",table.number = 1)
```
...
geom_errorbar(aes(ymin  = Trad.lower,
  ...
  theme_classic()+
  ggsave(file="C:/Users/CURRANT/Documents/Compendium/Plots/plot_2.png")
```
